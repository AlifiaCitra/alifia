...
with tab2:
    st.markdown("### Tabel Data Ringkas")
    st.write("Berikut adalah tabel ringkas seluruh uji untuk perbandingan cepat:")
    st.dataframe(
        df[["Nama Uji", "Gugus Fungsi", "Reagen", "Warna/Visual"]], 
        hide_index=True, 
        use_container_width=True
    )

# 5. Footer / Hak Cipta
st.caption("Dikembangkan untuk kemudahan belajar Kimia Organik | Di-hosting menggunakan GitHub & Streamlit Cloud")
